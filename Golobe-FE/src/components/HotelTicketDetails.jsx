          ...
          <div className=" rounded-lg bg-[#fafbfc] mt-10 flex justify-center">
            <div className="font-semibold text-[24px] bg-[#EBF6F2] w-[326px] p-6 border-[#EAEAEA] border-[1px] border-r-0 rounded-s-2xl">
              <div className='font-["Montserrat"] mb-2'>
                <h1 className="text-[32px]">Thur, Dec 8</h1>
              ...
              <div className="flex flex-col gap-2">
                ...
                />
                <img
                  className="w-[30px] h-[24px] ml-1"
                  src="./images/lightbuilding.png"
                  alt=""
                />
                <img
                  className="w-[30px] h-[36px]"
              ...
              <div className='font-["Montserrat"] mt-3'>
                <h1 className="text-[32px]">Fri, Dec 9</h1>
                <p className="text-[12px] font-medium">Check-Out</p>
              </div>
            </div>
            <div className="border-[#EAEAEA] border-[1px] border-l-0 rounded-e-2xl">
              <div className="w-[910px] h-[102px] bg-[#8DD3BB] rounded-se-2xl flex items-center justify-between p-6">
                ...
                <div>
                  <h1 className='font-semibold font-["Trade_Gothic_LT_Std"] text-[14px] text-right'>
                  Superior room - 1 double bed <br />or 2 twin beds
                  </h1>
                </div>
              </div>
                ...
                <div className="flex gap-8 items-center p-6 justify-around -mx-10">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="leading-none">
                      ...
                      <p className="text-[12px] font-medium">12:00pm</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="p-1 bg-[#EBF6F2] rounded-md">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="leading-none">
                      ...
                      <p className="text-[12px] font-medium">On arival</p>
                    </div>
                  </div>
                  {/* <div className="flex items-center gap-3">
                    <div className="p-1 bg-[#EBF6F2] rounded-md">
            ...
            <div className="w-[405px] h-[314px] bg-[#fff] border-[#EAEAEA] border-[1px] rounded-2xl flex items-center justify-center">
