  ...
  return (
    <div>
      ...
      <section className="w-full mb-48 ">
        <div className="bg-[url('/images/hotel-search-bg.jpg')]  bg-no-repeat relative shrink-0 h-[600px] bg-center overflow-hidden">
          <div class="absolute inset-0 w-full h-full to-bg-black-10 bg-gradient-to-t from-black/40 via-black/50"></div>
          <div className="flex flex-col text-white w-[35%] p-20 relative">
      ...
      <div className="flight-box mb-80 w-[80%] bg-white p-6 shadow-[0px_4px_16px_0px_rgba(141,211,187,0.15)] absolute top-[500px] left-[190px] rounded-xl ">
        <div className="flex flex-col gap-4">
          <h1 className="text-2xl typo ml-8">Where are you flying?</h1>
      ...
      <div>
        <section>
          <div className="mb-20">
            <div className="flex gap-8 mx-40 p-10 flex-col ">
